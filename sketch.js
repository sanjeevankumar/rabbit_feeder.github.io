...
var eating_sound;
 ...
 var star,star2 
 var blower
 var starDisplay,empty_star,one_stars,two_stars
function preload()
{
 ...
 one_stars = loadAnimation("one_star.png")
 two_stars=loadAnimation("stars.png")
  ...
  starDisplay.addAnimation('one',one_stars)
  starDisplay.addAnimation('two',two_stars)
